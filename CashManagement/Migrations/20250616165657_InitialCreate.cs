        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DailyUsed = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    MonthlyUsed = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CashLines", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CashLineProfit = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    InstaPayProfit = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    FawryProfit = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InstaPays", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TotalCashLineBalance = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TotalPhysicalCash = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TotalInstaPayBalance = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TotalSystemBalance = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CashTransactionsPhysical", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "InstaPayTransactions",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    InstaPayId = table.Column<int>(type: "int", nullable: false),
                    Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    FeesPercentage = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    FeesAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    NetAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TransactionType = table.Column<int>(type: "int", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InstaPayTransactions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InstaPayTransactions_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_InstaPayTransactions_InstaPays_InstaPayId",
                        column: x => x.InstaPayId,
                        principalTable: "InstaPays",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecipientNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CashTransactions_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CashTransactions_CashLines_CashLineId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    DebitCreditType = table.Column<int>(type: "int", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CashTransactions_CashLineId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InstaPayTransactions_ApplicationUserId",
                table: "InstaPayTransactions",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_InstaPayTransactions_InstaPayId",
                table: "InstaPayTransactions",
                column: "InstaPayId");
